...
int main() {
    int maximo = 100000; //Largo del vector
    ...
    for(int c=0;c<pruebas;c++){
        ...
        selectionSort(ra);                   //QuickSort ordenado al azar
        ...
        selectionSort(ra);                  //QuickSort ordenado ascendentemente
        ...
        selectionSort(ra);                  //QuickSort ordenado descendentemente
